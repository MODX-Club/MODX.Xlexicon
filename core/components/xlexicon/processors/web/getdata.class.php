...
class XlexiconWebGetDataProcessor extends XlexiconWebGetlistProcessor{
    ...
    protected function getOption($key,$options = array(),$default = ''){
      $options = array_merge($this->getProperties(),$options);
...
return 'XlexiconWebGetDataProcessor';