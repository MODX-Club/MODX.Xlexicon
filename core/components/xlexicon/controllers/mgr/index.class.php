...
class XlexiconManagerController extends modExtraManagerController{
    
  public $module = 'xlexicon';
  public $module_name = 'Xlexicon';
  ...
  function loadCustomCssJs(){
    ...
    $this->addJavascript($this->getOption('assets_url').'js/xlexicon.js'); 
